...
def DirectoryWatcher(FolderName,Extention1,Extention2):
    ...
    for FolderName,subfolderName,FileNames in os.walk(FolderName):
        for fname in FileNames:
            if fname.endswith(Extention1):
                ...
                Newfname=fname.replace(Extention1,Extention2)
...
def main():
   ...
   if (len(sys.argv)==2):
        if((sys.argv[1]=="--h") or sys.argv[1]=="--H"):
            print("This application is used to rename the given extention file.")
            
        elif((sys.argv[1]=="--u") or sys.argv[1]=="--U"):
            print("Use the given script as")
            print("ScriptName.py NameofDirectory .fileExtention .NewfileExtention")
