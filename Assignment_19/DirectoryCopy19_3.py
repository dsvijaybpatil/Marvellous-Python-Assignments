...
def DirectoryCopy(FolderName,NewFolderName):
...
def main():
   ...
   if (len(sys.argv)==2):
        if((sys.argv[1]=="--h") or sys.argv[1]=="--H"):
            print("This application is used to copy all files from one Directory to another Directory. ")
            
        elif((sys.argv[1]=="--u") or sys.argv[1]=="--U"):
            print("Use the given script as")
            print("ScriptName.py NameofDirectory NameofNewDirectory")
